...
<!-- POSISI GEDUNG  E -->
L.marker([ -5.360026, 105.315530]).addTo(map);
<!-- POSISI GEDUNG  F -->
...
<!-- POSISI EMBUNG A -->
L.marker([ -5.357994, 105.311804]).addTo(map);
<!-- POSISI EMBUNG B -->
...
L.marker([ -5.369924, 105.310619]).addTo(map);
<!-- POSISI LABIRIN  -->
...
<!-- MENAMPILKAN NAMA GEDUNG GKU 1 -->
    ...
    var E = L.marker([-5.360026, 105.315530]);
    ...
    var EmbungA = L.marker([-5.357994, 105.311804]);
    ...
    var EmbungSumatera = L.marker([-5.369924, 105.310619]);
